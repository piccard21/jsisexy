define(['jquery', 'underscore'], function ($, _) {
    JSSEXY.e09_oo_chainable = function () { 
        ...
        var userController = {
            ...
            createLayout: function () {
                if (this.currentUser) {
                    this.currentUser.viewData = "<h2>Member: " +
                            this.currentUser.fullName + "</h2><p>ID:" + this.currentUser.id + "</p>" +
            ...
            displayUser: function () {
                if (!this.currentUser)
                    return;
                $("body").append(this.currentUser.viewData);
            }
        };

        userController.findUser("test2@test2.com")
                .formatName()
                .createLayout()
                .displayUser();
    }
